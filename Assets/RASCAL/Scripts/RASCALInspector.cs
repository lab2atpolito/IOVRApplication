...
public class RASCALInspector : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        if(GUILayout.Button(new GUIContent("Clear", "Destroy all mesh colliders and data generated by this script. " +
        ...
        bool useThreadedColMeshBaking = EditorGUILayout.ToggleLeft(GetContent("useThreadedColMeshBaking"), rascal.useThreadedColMeshBaking, label);
#endif
        ...
        assocAndExcludeAnim.target = EditorGUILayout.Foldout(assocAndExcludeAnim.target, "Material Associations & Exclusions", true, new GUIStyle(EditorStyles.foldout) { fontStyle = FontStyle.Bold, fontSize = 12 });
